...
CREATE TABLE "blog_posts" (
	`ID`	INTEGER NOT NULL DEFAULT 'None' PRIMARY KEY AUTOINCREMENT,
	`post_author`	VARCHAR(20) NOT NULL DEFAULT 'demo',
	`post_date`	DATETIME NOT NULL DEFAULT '0000-00-00 00-00-00',
	`post_content`	TEXT NOT NULL DEFAULT 'None',
	`post_title`	TEXT NOT NULL DEFAULT 'None',
	`post_name`	VARCHAR(200) NOT NULL DEFAULT 'new post',
	`post_excerpt`	TEXT NOT NULL DEFAULT 'None',
	`post_image`	VARCHAR(20) DEFAULT 'road_big.jpg',
	`post_status`	VARCHAR(20) NOT NULL DEFAULT 'publish',
	`post_modified`	DATETIME NOT NULL DEFAULT '0000-00-00 00-00-00',
	`comment_status`	VARCHAR(20) NOT NULL DEFAULT 'open',
	`post_password`	VARCHAR(20) NOT NULL DEFAULT 'None',
	`post_likes`	VARCHAR(20) NOT NULL DEFAULT '0'
);
